...
export default [
  ...
  {
    "id": "rec6iVy9sO0UJD63V",
    "fields": {
      "Song": "Ant kalnelio malūnas",
      "Lyrics": "Ant kalnelio malūnas,\nAnt kalnelio malūnas;\n\nEi julį, julija\nValerija julidama\nSalapula puldama\nCalavyja cap lap. (2 k.)\n\nTen gyveno bajoras.\nJis turėjo tris dukras.\nEi julį...\n\nViena buvo Onytė.\nAntra buvo Rožytė.\nEi julį...\n\nTrečia buvo Julija.\nTrečia buvo Julija!\nEi julį...\n\nPas Rožytę bajoras.\nPas Onytę artojas.\nEi julį...\n\nPas Juliją čigonas.\nPas Juliją čigonas.\nEi julį...\n",
      "Source": [
        "Romuva",
        "Dainava",
        "MAS"
  ...
  {
    "id": "recG7Pb9ogyCpba4y",
    "fields": {
      "Song": "Ant kalno gluosnys",
      "Lyrics": "Džium, džium-džium,\nDžium, džium-džium...\n\nAnt kalno gluosnys,\nPakalnėj šulnys,\nTen stovėjo mergužėlė\nPati sau viena. (2 k.)\n\nDžium, džium-džium,\nDžium, džium-džium...\n\nJojo bernelis\nŽirgo girdyti,\nSustok, palauk mergužėle,\nDuok žirgui vandens.\n\nDžium, džium-džium,\nDžium, džium-džium...\n\nNegaliu stovėt,\nSu tavim kalbėt,\nŠalta rasa, o aš basa, -\nNušals kojelės.\n\nDžium, džium-džium,\nDžium, džium-džium...\n",
      "Source": [
        "Romuva",
        "Dainava",
        "MAS"
  ...
  {
    "id": "reccyLnFeCS8h6uSw",
    "fields": {
      "Song": "Apie Joną ir molio uzboną",
      "Lyrics": "Ėjo, ėjo mergužėlė,\nBalta graži lelijėlė,\nIr sutiko Joną,\nSudaužė uzboną. (2 k.)\n\nVerkė, verkė mergužėlė,\nBalta graži lelijėlė,\nMolinio uzbono,\nMolio uzbonėlio. (2 k.)\n\nCit, neverki, mergužėle,\nBalta graži lelijėle,\nImki bėrą žirgą\nUž molio uzboną. (2 k.)\n\nVerkė, verkė mergužėlė,\nBalta graži lelijėlė,\nMolinio uzbono,\nMolio uzbonėlio. (2 k.)\n\nCit, neverki, mergužėle,\nBalta graži lelijėle,\nImki aukso žiedą\nUž molio uzboną. (2 k.)\n\nVerkė, verkė mergužėlė,\nBalta graži lelijėlė,\nMolinio uzbono,\nMolio uzbonėlio. (2 k.)\n\nCit, neverki, mergužėle,\nBalta graži lelijėle,\nImki mane, Joną,\nUž molio uzboną. (2 k.)\n\nDžiaugės, džiaugės mergužėlė,\nBalta graži lelijėlė,\nIšsimainius Joną\nUž molio uzboną. (2 k.)\n",
      "Source": [
        "Dainava",
        "MAS"
      ]
  ...
  {
    "id": "rec5CxJetwZFaIjZr",
    "fields": {
      "Song": "Ateina naktis",
      "Lyrics": "Ateina naktis\nSaulė jau nuslinko\nNuo kalnų,\nNuo miškų,\nNuo laukų.\nSaldžių sapnų, užmiki,\nDievs yr' čia!\n",
      "Source": [
        "Romuva"
      ]
    }
  ...
  {
    "id": "recBXo5mQjHjwt6Ix",
    "fields": {
      "Song": "Čing čang gū",
      "Lyrics": "Čing čang gū, gūra gūra vačia,\nČing čang gū rava čia gū. (2 k.)\n\nEi julį, ei julį, ei julį,\nEi julį, ei julį, ei julį,\nČing čang gū.\n",
      "Source": [
        "Romuva"
      ]
    }
  ...
  {
    "id": "recKDZMGuIBEzfciN",
    "fields": {
      "Song": "Daina iš širdies",
      "Lyrics": "Daina iš širdies į širdį plaukia,\nKviečia amžiais būt dainos draugu. (2 k.)\n\nDainuok, dainuok\nIr nenustok.\n\nSmagu kartu!\nPer dainą man tapai draugu!\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
  ...
  {
    "id": "rec2ONvmngRYX2MEj",
    "fields": {
      "Song": "Iš rytų šalelės",
      "Lyrics": "Iš rytų šalelės\nSaulelė tekėjo,\nO iš vakarėlių\nDebesėliai ėjo. (2 k.)\n\nPamačiau mergelę\nKeleliu einančią,\nKaip rytų saulelę\nSkaisčiai užtekančią. (2 k.)\n\nEik, šen, mergužėle,\nPrie mano šalelės,\nMudu pakalbėsim\nDaug meilių žodelių. (2 k.)\n",
      "Source": [
        "Dainava",
        "MAS"
      ]
  ...
  {
    "id": "recWOk9J2QNfOD0Lo",
    "fields": {
      "Song": "Jei patinka jums paukštytės",
      "Lyrics": "Jei patinka jums paukštytės\nTai suplot. (5 k.)\n\nJei patinka jums paukštytės\nSutrepsėt. (5 k.)\n\nJei patinka jums paukštytės\nHip valio. (5 k.)\n\nJei patinka jums paukštytės\nVisus tris / suplot / sutrepset / hip valio (5 k.)\n\n",
      "Source": [
        "Romuva"
      ]
    }
  ...
  {
    "id": "recq5ec0sMKl3DRTH",
    "fields": {
      "Song": "Sarbinčiula ogėla",
      "Lyrics": "Sarbinčiula ogėla,\nO kas tavi augino?\nSorbinto, sorbinto,\nSorbinto, sorbinto.\n\nSarbinčiula ogėla,\nMan lėtutis augino.\nSorbinto...\n\nSarbinčiula ogėla,\nO kas tavį siurbino?\nSorbinto...\n\nSarbinčiula ogėla,\nMan saulala siurbino.\nSorbinto...\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
  ...
  {
    "id": "rec2AQkAJ4STQp7CB",
    "fields": {
      "Song": "Sėdžiu už stalelio",
      "Lyrics": "Sėdžiu už stalelio,\nŽiūriu pro langelį.\nČiūčiuoja, liūliuoja\nAnt marių laivelis... (2 k.)\n\nO tame laively\nMergelė sėdėjo.\nJūrelių putelėm\nSau burnelę prausė. (2 k.)\n\nJūrelių putelėm\nSau burnelę prausė,\nŽuvelių šukelėm\nGalvelę šukavo. (2 k.)\n\nŽuvelių šukelėm\nGalvelę šukavo,\nSkandino žiedelį\nĮ marių dugnelį. (2 k.)\n\nPlauki sau, žiedeli,\nTolimon šalelėn,\nTolimon šalelėn,\nKur mano bernelis. (2 k.)\n",
      "Source": [
        "Dainava",
        "MAS"
      ]
  ...
  {
    "id": "recYGzMycBKqTLmtL",
    "fields": {
      "Song": "Šlama šilko vėjas",
      "Lyrics": "Šlama šilko vėjas,\nAguonėlės žydi.\nEi valio, saulute,\nTu visur mus lydi.\n\nLylia, oi lylia,\nLylia, oi lylia,\nEi valio, saulute,\nTu visur mus lydi.\n\nSu tavim kas rytą\nIš lovelės keliam.\nVakare palydim\nMes tave dainelėm.\nLylia...\n\nSu tavim pražysta\nMūsų jaunos dienos,\nBaltos, kaip lelijos,\nGelsvos, kaip purienos.\nLylia...\n\nEi, valio, saulute,\nSaule, auksakase,\nEsam tavo broliai,\nEsam tavo sesės.\nLylia...\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
  ...
  {
    "id": "rec07T8RgIyqqL3e3",
    "fields": {
      "Song": "Svečiai, svečiai",
      "Lyrics": "Svečiai, svečiai,\nSakau jums stačiai –\nSuvalgėt pyragą.\nPrimynėt padlagą.\nVažiuokit namo!\n\nSvečiai, svečiai,\nSakau jums stačiai –\nSuvalgėt skilandį\nIr kiaulės pažandį.\nVažiuokit namo!\n\nSvečiai, svečiai,\nSakau jums stačiai –\nSuvalgėt bulvienę,\nZacirką, žirnienę.\nVažiuokit namo!\n\nSvečiai, svečiai,\nSakau jums stačiai –\nSuvalgėt ir silkę\nMandrai apsivilkę.\nVažiuokit namo!\n\nSvečiai, svečiai,\nNebūkit žiopliai.\nMokėjot ateit –\nMokėkit išeit.\nVažiuokit namo!\n",
      "Source": [
        "Dainava",
        "MAS"
      ]
  ...
  {
    "id": "recBA5JG4tK4ajIQ6",
    "fields": {
      "Song": "Trikampė kepurė",
      "Lyrics": "Štai aš turiu kepurę,\nTrikampę aš turiu.\nJei ji nebūtų trikampė,\nNebūtų ji mano.\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
  ...
  {
    "id": "recs36q65Nf0BJUQp",
    "fields": {
      "Song": "Vai, kelkites, vaikeliai",
      "Lyrics": "Vai kelkitės vaikeliai,\nGamta jau atsigavo.\nSaulutė linksmai šviečia,\nGegutė užkukavo:\n\n-Vai kelk, vai kelk-\nGamta jau atsigavo;\nSaulutė linksmai šviečia,\nGegutė užkukavo.\n\nKu-ku, ku-ku, ku-ku, ku-ku,\nKu-ku, ku-ku, ku-ku. (2 k.)\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
  ...
  {
    "id": "recmlvEuRiu47uDPp",
    "fields": {
      "Song": "Vakar, šiandien, visada",
      "Lyrics": "Stovyklauti Dainavoj\nGrįžtame dažnai.\nŽaisti, juoktis ir dainuot,\nMums čia kaip namai.\n\nVakar, šiandien, visada,\nMes visi draugai,\nVakar, šiandien, visada,\nDainavos vaikai.\n\nMetai bėga greitai,\nKeičiasi gamta.\nO draugystė bręsta\nLaimės kupina.\n\nVakar, šiandien, visada...\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
  ...
  {
    "id": "recHZVGyvqS6qTUsU",
    "fields": {
      "Song": "Viskas praeina čia",
      "Lyrics": "Viskas praeina čia,\nNegrįžta nieks.\nLieka tik muzika,\nLieka tik muzika,\nLieka tik muzika,\nJi amžina!\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
  ...
  {
    "id": "recRrfViVutxj9EJs",
    "fields": {
      "Song": "Žemėj Lietuvos",
      "Lyrics": "Tu tokia brangi,\nŽeme mūs gimta!\nTau mintis šviesi,\nTau širdy vieta.\n\nŽemėj Lietuvos\nĄžuolai žaliuos,\nĄžuolai žaliuos\nŽemėj Lietuvos.\n\nTu tokia maža\nIr tokia didi,\nNemuno vaga\nLietuvos širdy.\n\nŽemėj Lietuvos...\n\nAr diena dienos,\nAr naktelė tems,\nDuok mums šilumos\nDuonos ir vandens.\n\nŽemėj Lietuvos...\n",
      "Source": [
        "Dainava",
        "MAS"
      ],
